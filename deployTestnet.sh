...
# forge script script/SetUpPool.s.sol:SetUpPool --chain-id $CHAIN_ID --fork-url $RPC_URL -vv

# forge script script/UpgradePool.s.sol:UpgradePool --chain-id $CHAIN_ID --fork-url $RPC_URL -vv
...
# forge script script/UpgradeRole.s.sol:UpgradeRole --chain-id $CHAIN_ID --fork-url $RPC_URL --broadcast -vv
...
# forge script script/UpgradeEquip.s.sol:UpgradeEquip --chain-id $CHAIN_ID --fork-url $RPC_URL -vv

# forge script script/DeployOGColourSBT.s.sol:D/eploySBT --chain-id $CHAIN_ID --fork-url $RPC_URL --etherscan-api-key $POLYGONSCAN_API_KEY --broadcast -vvvv
...
# forge script script/UpgradeOGColourSBT.s.sol:UpgradeOGColourSBT --chain-id $CHAIN_ID --fork-url $RPC_URL --broadcast
...
# forge script script/ComputeSlot.s.sol:ComputeSlot --chain-id $CHAIN_ID --fork-url $RPC_URL 
# forge script script/ReadPoolStatus.s.sol:ReadStatus --chain-id $CHAIN_ID --fork-url $RPC_URL 